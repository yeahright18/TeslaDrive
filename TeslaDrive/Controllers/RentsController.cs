...
namespace TeslaDrive.Controllers
{
    public class RentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Surname,Email,TelephoneNumber")] Rent rent)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Surname,Email,TelephoneNumber")] Rent rent)
        {
            if (id != rent.Id)
            {
                return NotFound();
